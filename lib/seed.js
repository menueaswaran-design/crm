...
export async function seedDatabase() {
  ...
  const invoices = await Invoice.insertMany(invoicesData.map((inv) => {
    ...
    return { ...inv, subtotal, gstAmount, totalAmount, paidAmount: 0, outstandingAmount: totalAmount };
  }));
  ...
  await Activity.insertMany([
    { userId: priya._id, action: "TASK_COMPLETED", entityType: "Task", description: "Priya Sharma completed GSTR-1", createdAt: dayOffset(-1) },
    { userId: admin._id, action: "CLIENT_CREATED", entityType: "Client", description: "Rajesh Kumar added Meena Enterprises", createdAt: dayOffset(-4) },
    { userId: admin._id, action: "INVOICE_CREATED", entityType: "Invoice", description: "New invoice INV-2026-004 created", createdAt: dayOffset(-5) },
    { userId: amit._id, action: "DOCUMENT_UPLOADED", entityType: "Document", description: "Form 16 document uploaded", createdAt: dayOffset(-6) },
  ]);
