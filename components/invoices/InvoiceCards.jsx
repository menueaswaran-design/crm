  ...
  return (
    <div className="flex flex-col gap-3">
      {invoices.map((inv) => {
        ...
        return (
          <div key={inv._id} className="card card-hover animate-fade-in-up overflow-hidden relative">
            {/* Mobile: stacked layout */}
            <div className="flex sm:hidden flex-col p-4 gap-3">
            ...
            <div className="hidden sm:flex items-center gap-4 p-4">
              ...
              <div className="flex items-center gap-2 shrink-0">
                {inv.outstandingAmount > 0 && (
                  <Button size="sm" variant="secondary" className="hidden md:inline-flex" onClick={() => onPayment(inv)}>
                    <Banknote size={13} /> Payment
                  </Button>
                )}
                {inv.outstandingAmount > 0 && inv.clientId?.phone && (
